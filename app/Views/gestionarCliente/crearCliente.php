<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <!-- formulario -->
            <form method="post" action="<?php echo base_url(); ?>cliente/insertar" autocomplete="off">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            ...
                            <input type="text" class="form-control" id="ci" name="ci" value="<?php echo set_value('nombre') ?>" autofocus required>
                        </div>
