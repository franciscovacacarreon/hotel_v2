...
<div id="layoutSidenav_content">
            ...
            <form method="POST" id="form-nota-hospedaje" name="form-nota-hospedaje" action="<?php echo base_url() ?>notahospedaje/guarda" autocomplete="off">
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            ...
                            <input type="hidden" id="id_notaHospedaje" name="id_notaHospedaje" value="<?php echo $id_notaHospedaje ?>">
                        ...
                        <div class="col-12 col-sm-4">
                            ...
                            <input class="form-control" id="fechaEntrada" name="fechaEntrada" type="date" required>
                        </div>

                        <div class="col-12 col-sm-4">
                            <label for="">Fecha de salida</label>
                            <!--set_value cuando de actualiza el formulario no se pierde lo que el usuario escribio -->
                            <input class="form-control" id="fechaSalida" name="fechaSalida" type="date" required>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-4">
                            <label class="form" for="">Tipo de pago</label>
                            <!--set_value cuando de actualiza el formulario no se pierde lo que el usuario escribio -->
                        ...
                        <div class="col-12 col-sm-4">
                            ...
                            <label for=""> <br> &nbsp;</label>
                            <!--set_value cuando de actualiza el formulario no se pierde lo que el usuario escribio -->
                            <button id="agregar_servicio" name="agregar_servicio" type="button" class="btn btn-primary" onclick="agregarHospedaje(nro_habitacion.value, 0, '<?php echo $id_notaHospedaje; ?>')">Agregar habitación</button>
                        </div>

                    </div>
                    <div class="row d-flex justify-content-end align-items-end">
                        <div class="col-12 col-sm-4" style="display: none;">
                            <!-- <label class="form" for="">Reserva</label> -->
                            <!--set_value cuando de actualiza el formulario no se pierde lo que el usuario escribio -->
                            <select class="form-control" name="id_reserva" id="id_reserva" required>
                ...
                <div class="row my-3">
                    <table id="tablaHospedajes" class="table table-hover table-striped table-sm table-responsive tablaHospedajes" width="100%">
                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-md-6">
                        ...
                        <button type="button" id="completa-hospedaje" class="btn btn-success my-3">Completar hospedaje</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        const tablaHospedaje = document.getElementById("tablaHospedajes");
        const form = document.getElementById("form-nota-hospedaje");
        ...
        function agregarHospedaje(nro_habitacion, cantidad, id_notaHospedaje) {
            ...
            if (nro_habitacion != null && id_notaHospedaje != 0 && cantidad >= 0 && existeClienteReserva) {
                //utilizando ajax
                    ...
                    success: function(resultado) {
                        if (resultado == 0) {
                            ...
                            if (resultado != '') {
                                ...
                                $('#tablaHospedajes tbody').empty();
                                $('#tablaHospedajes tbody').append(resultado.datos);
